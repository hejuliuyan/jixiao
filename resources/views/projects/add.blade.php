    ...
    <div class="area-wrap">
        ...
        <div class="sheet">
            ...
            <div class="sheet-middle">
                <form class="project-form" method="post" action="{{ route('project.create') }}" accept-charset="UTF-8">
                    {{ csrf_field() }}
                            ...
                            <div class="tab-pane active" id="base">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="sheet-item">
                                                <input type="text" name="name" class="form-control" title="请填写项目名称" value="{{ old('name') }}"/>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="sheet-item" style="width: 22%">
                                                <input type="text" name="contract_num" class="form-control" maxlength="50" title="请填写咨询合同编号" value="{{ old('contract_num') }}"/>
                                            </div>
                                            <div class="sheet-item" style="width: 17%">工程造价（万元）</div>
                                            <div class="sheet-item" style="width: 22%">
                                                <input type="text" name="cost" class="form-control" title="请填写工程造价" value="{{ old('cost') }}"/>
                                            </div>
                                            <div class="sheet-item" style="width: 17%">合同费用（万元）</div>
                                            <div class="sheet-item" style="width: 22%">
                                                <input type="text" name="contract_price" class="form-control" title="请填写合同费用" value="{{ old('contract_price') }}"/>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="sheet-item">
                                                <input type="text" name="depute_name" class="form-control" title="请填写委托单位名称" value="{{ old('depute_name') }}"/>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <div class="sheet-item" style="width: 30%">
                                                <input type="text" name="depute_user" class="form-control" maxlength="50" title="请填写委托联系人" value="{{ old('depute_user') }}"/>
                                            </div>
                                            <div class="sheet-item" style="width: 20%">联系电话</div>
                                            <div class="sheet-item" style="width: 30%">
                                                <input type="text" name="depute_phone" class="form-control" title="请填写委托单位联系电话" placeholder="请输入11位手机号或区号-座机号码" value="{{ old('depute_phone') }}"/>
                                            </div>
                                        </td>
                                    </tr>
                                                ...
                                                <ul>
                                                    ...
                                                    {{--<li><i class="fa fa-circle"></i>提取项目信息：单项工程（--}}
                                                        {{--<select name="single" title="单项工程">--}}
                                                            {{--<option value="0" @if(old('single') === '0') selected @endif>否</option>--}}
                                                            {{--<option value="1" @if(old('single') === '1') selected @endif>是</option>--}}
                                                        {{--</select>--}}
                                                        {{--）；单位工程（--}}
                                                        {{--<select name="unit" title="单位工程">--}}
                                                            {{--<option value="0" @if(old('unit') === '0') selected @endif>否</option>--}}
                                                            {{--<option value="1" @if(old('unit') === '1') selected @endif>是</option>--}}
                                                        {{--</select>--}}
                                                        {{--）；不提取（--}}
                                                    ...
                                                    <li><i class="fa fa-circle"></i>提取项目信息：
                                                        <input type="checkbox" name="single" value="1">单项工程&nbsp;&nbsp;
                                                        <input type="checkbox" name="unit" value="1">单位工程&nbsp;&nbsp;
                                                    ...
                                                    <li><i class="fa fa-circle"></i>是否进行咨询合同备案：
                                                        <select name="record" title="是否进行咨询合同备案">
                                                            <option value="0" @if(old('record') === '0') selected @endif>否</option>
                                                            <option value="1" @if(old('record') === '1') selected @endif>是</option>
                                                        </select>
                                                    </li>
                                                </ul>
                                            </div>
            ...
            <div class="sheet-footer">
                <button type="button" class="btn btn-success" onclick="RHA.order(this)" data-action="{{ route('project.order')}}">下单</button>
